...
public class SampleRect {
    ...
    public String toString() {
        ...
        sb.append(SampleRect.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SampleRect) == false) {
            return false;
        }
        SampleRect rhs = ((SampleRect) other);
