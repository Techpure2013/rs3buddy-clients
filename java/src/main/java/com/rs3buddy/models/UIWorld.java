...
public class UIWorld {
    ...
    public String toString() {
        ...
        sb.append(UIWorld.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UIWorld) == false) {
            return false;
        }
        UIWorld rhs = ((UIWorld) other);
