...
public class SkillRect {
    ...
    public String toString() {
        ...
        sb.append(SkillRect.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SkillRect) == false) {
            return false;
        }
        SkillRect rhs = ((SkillRect) other);
