...
public class ChatRect {
    ...
    public String toString() {
        ...
        sb.append(ChatRect.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChatRect) == false) {
            return false;
        }
        ChatRect rhs = ((ChatRect) other);
