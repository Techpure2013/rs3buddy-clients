...
public class BuffRect {
    ...
    public String toString() {
        ...
        sb.append(BuffRect.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BuffRect) == false) {
            return false;
        }
        BuffRect rhs = ((BuffRect) other);
